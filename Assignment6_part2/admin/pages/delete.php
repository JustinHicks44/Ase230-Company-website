...
<head>
    ...
    <title>Delete Page - <?php echo htmlspecialchars($page['title']); ?></title>
    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="delete-section">
                <h2 class="mb-4">Delete Page</h2>
                <div class="alert alert-warning">
                    <p><strong>Are you sure you want to delete this page?</strong></p>
                    <p class="mb-0"><strong>Title:</strong> <?php echo htmlspecialchars($page['title']); ?></p>
                </div>

                <form method="POST">
                    <div class="mt-4">
                        <button type="submit" name="confirm" value="yes" class="btn btn-danger">Yes, Delete Page</button>
