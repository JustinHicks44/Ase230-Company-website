...
<head>
    ...
    <title>Product Details - <?php echo htmlspecialchars($product['Product']); ?></title>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><?php echo htmlspecialchars($product['Product']); ?></h1>
                <div>
            ...
            <div class="detail-section">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9"><?php echo htmlspecialchars($product['id']); ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3"><strong>Product Name:</strong></div>
                    <div class="col-md-9"><?php echo htmlspecialchars($product['Product']); ?></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3"><strong>Short Description:</strong></div>
                    <div class="col-md-9"><?php echo nl2br(htmlspecialchars($product['ShortDescription'])); ?></div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <ul>
                            <?php
                            $apps = explode('|', $product['Applications']);
                            foreach ($apps as $app) {
                                $app = trim($app);
                                if ($app) {
