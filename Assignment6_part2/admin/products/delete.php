...
<head>
    ...
    <title>Delete Product - <?php echo htmlspecialchars($product['Product']); ?></title>
        ...
        <div class="col-md-6 mx-auto">
            <div class="delete-section">
                ...
                <div class="alert alert-warning">
                    ...
                    <p class="mb-0"><strong>Product Name:</strong> <?php echo htmlspecialchars($product['Product']); ?></p>
                </div>

                <form method="POST">
                    <div class="mt-4">
                        <button type="submit" name="confirm" value="yes" class="btn btn-danger">Yes, Delete Product</button>
