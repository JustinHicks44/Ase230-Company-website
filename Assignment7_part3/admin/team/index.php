    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="create.php" class="btn btn-success">+ Add Team Member</a>
            </div>

            <?php if (empty($team)): ?>
                <div class="alert alert-info">No team members found. <a href="create.php">Add one now</a>.</div>
            <?php else: ?>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr style="cursor: pointer;" onclick="window.location.href='detail.php?id=<?php echo $index; ?>'">
                            ...
                            <td><?php echo htmlspecialchars(substr($member['bio'], 0, 50)); ?></td>
